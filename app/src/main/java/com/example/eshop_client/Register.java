            ...
            public void onClick(View v) {
               ...
               ///////////////////////////////////////////////////////////////////////////////////////////
                        ...
                        ||String.valueOf(RePassword.getText()).isEmpty())
                {
                    ...
                    registerURL = "http://192.168.1.41:3000/register?" + "email=" + email.getText() +"&password="+Password.getText()+"&name="+String.valueOf(firstName.getText())+"%20"+String.valueOf(lastName.getText());
