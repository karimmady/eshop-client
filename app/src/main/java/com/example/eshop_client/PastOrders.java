...
public class PastOrders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            System.out.println("pastorderassssssssss");
        ...
        listPastOrder.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String clickedItem=(String) listPastOrder.getItemAtPosition(position);
                Toast.makeText(PastOrders.this,clickedItem,Toast.LENGTH_LONG).show();
